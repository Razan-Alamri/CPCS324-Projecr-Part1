 ...
 */public class MHPrimAlg extends MSTAlgorithm {
    ...
    public void displayResultingMST(boolean isFile) {
         ...
         * if vertex not in heap--> the index (which is equal to vertex label) will be
         * false
         */
        ...
        // for loop to for each vertex to create heapNode for every vertex with
        // key=infinity
        ...
        while (!minHeap.isEmpty()) {
            ...
            inHeap[extractedVertex.ID] = false;
     ...
     */
    public int ResultingMST(Edge[] edgesList) {
        int cost = 0;
