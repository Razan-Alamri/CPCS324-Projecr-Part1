...
public class MHPrimAlg extends MSTAlgorithm {
     ...
     * MSTResultList[extractedVertex].source.isVisited = true; //mark the extracted
     * vertex ad visited
     * 
     * LinkedList<Edge> list = graph.vertices[extractedVertex].adjList;//for all
     * edges of the vertex
     ...
     * //buble the child up
     * while (currentIndex > 0 && MinHeapArr[parentIndex].weight >
     * MinHeapArr[currentIndex].weight) {
     * 
     ...
     * indexes[lastNode.source.label] = 1; //put the last emlent as the first
     * element in the hrap
     ...
     * if (leftChildIndex < heapSize() && MinHeapArr[smallest].weight >
     * MinHeapArr[leftChildIndex].weight) {
     * smallest = leftChildIndex;
     * }
     * if (rightChildIndex < heapSize() && MinHeapArr[smallest].weight >
     * MinHeapArr[rightChildIndex].weight) {
